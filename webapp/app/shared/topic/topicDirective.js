	...
	angular.module('athenaApp')
	    .directive('topicDirective', ['$http', 'topicService', 'flash', function(
	        $http,
	        $topicService, $flash) {
	        ...
	        return {
	            ...
	            link: function(scope) {
	                ...
	                scope.$watch('topic', function() {
	                    scope.formData = scope.topic.settings;
	                });
	                ...
	                scope.saveTopic = function() {
	                    ...
	                    scope.topic.settings = scope.formData;
	                    $topicService.saveTopic(scope.topic);
	                    $flash.success = 'Saved Topic!';
	                };
	                ...
	                $http.get('/records/' + scope.topic._id +
	                        '?interval=15').success(
	                        function(
	                            data) {
