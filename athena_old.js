 ...
 * topic -> The topic that the message was published to
 * message ->
 *
 */
 function processIncomingMessage(db, topic, message){
   // First we take a look at the topic
   // - verifyOrCreateTopic

   // Then we prepare the message for insertion

   // At this point we want to run any 'jit rules' on the message

   // Finally we want to commit it to the collection
 }
